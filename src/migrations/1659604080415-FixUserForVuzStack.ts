...
export class FixUserForVuzStack1659604080415 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`isActivated\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`gender\` enum ('male', 'women', 'other') NOT NULL DEFAULT 'other'`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`isActived\` tinyint NOT NULL DEFAULT '0'`);
    }
