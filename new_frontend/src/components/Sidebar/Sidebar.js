          ...
          >
                ...
                >
                  <i
                    className={
                      ...
                      (window.location.href.indexOf("/users/tables") !== -1
                        ? "opacity-75"
                        : "text-blueGray-300")
                    }
                  ></i>{" "}
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="inline-flex">
                ...
                >
                  <i className="fas fa-landmark mr-2 text-blueGray-300 text-base"></i>
                  База ВУЗов
                </a>
              </li>
              <li className="inline-flex">
                <a
                  ...
                  className="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"
                >
                  <i className="fa fa-book mr-2 text-blueGray-300 text-base"></i>
                  Рецепты
                </a>
              </li>
